...
functions = {
    ...
    "__nv_double2float_rd": (float32, [arg(name="d", ty=float64, is_ptr=False)]),
    "__nv_double2float_rn": (float32, [arg(name="d", ty=float64, is_ptr=False)]),
    "__nv_double2float_ru": (float32, [arg(name="d", ty=float64, is_ptr=False)]),
    "__nv_double2float_rz": (float32, [arg(name="d", ty=float64, is_ptr=False)]),
    ...
    "__nv_double_as_longlong": (int64, [arg(name="x", ty=float64, is_ptr=False)]),
    ...
    "__nv_frexp": (
        float64,
        [arg(name="x", ty=float64, is_ptr=False), arg(name="b", ty=int32, is_ptr=True)],
    ),
    "__nv_frexpf": (
        float32,
        [arg(name="x", ty=float32, is_ptr=False), arg(name="b", ty=int32, is_ptr=True)],
    ),
    ...
    "__nv_llmax": (
        int64,
        [arg(name="x", ty=int64, is_ptr=False), arg(name="y", ty=int64, is_ptr=False)],
    ),
    "__nv_llmin": (
        int64,
        [arg(name="x", ty=int64, is_ptr=False), arg(name="y", ty=int64, is_ptr=False)],
    ...
    "__nv_longlong_as_double": (float64, [arg(name="x", ty=int64, is_ptr=False)]),
    "__nv_max": (
        int32,
        [arg(name="x", ty=int32, is_ptr=False), arg(name="y", ty=int32, is_ptr=False)],
    ),
