...
declare i32 @"_ZN8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx"(i64* %".1", {i8*, i32, i8*}** %".2", i64 %".3", i64 %".4")

define i8* @"_ZN7cpython8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx"(i8* %"py_closure", i8* %"py_args", i8* %"py_kws")
{
entry:
  %".5" = alloca i8*
  %".6" = alloca i8*
  %".7" = call i32 (i8*, i8*, i64, i64, ...) @"PyArg_UnpackTuple"(i8* %"py_args", i8* bitcast ([2 x i8]* @".const.f" to i8*), i64 2, i64 2, i8** %".5", i8** %".6")
  %".8" = icmp eq i32 %".7", 0
  %".22" = alloca i64
  store i64 0, i64* %".22"
  %".38" = alloca i64
...
entry.if:
  ret i8* null
entry.endif:
  %".12" = load i8*, i8** @"_ZN08NumbaEnv8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx"
...
arg.end:
  ret i8* null
entry.endif.if:
  call void @"PyErr_SetString"(i8* @"PyExc_RuntimeError", i8* bitcast ([92 x i8]* @".const.missing Environment: _ZN08NumbaEnv8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx" to i8*))
  ret i8* null
entry.endif.endif:
  %".21" = load i8*, i8** %".5"
...
entry.endif.endif.endif.endif.endif.endif:
  store i64 0, i64* %".53"
  %".57" = call i32 @"_ZN8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx"(i64* %".53", {i8*, i32, i8*}** %"excinfo", i64 %".31", i64 %".47") noinline
...
@".const.missing Environment: _ZN08NumbaEnv8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx" = internal constant [92 x i8] c"missing Environment: _ZN08NumbaEnv8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx\00"
