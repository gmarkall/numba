...
define i64 @"cfunc._ZN8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx"(i64 %".1", i64 %".2")
{
entry:
  %".4" = alloca i64
  store i64 0, i64* %".4"
  ...
  %".8" = call i32 @"_ZN8__main__1fB2v1B36c8tJTIcFHzwl2ILiXkcBV0IBS2sCAA_3d_3dExx"(i64* %".4", {i8*, i32, i8*}** %"excinfo", i64 %".1", i64 %".2") noinline
...
entry.endif:
  ret i64 %".18"
.23:
  %".45" = call i8* @"PyUnicode_FromString"(i8* bitcast ([53 x i8]* @".const.<numba.core.cpu.CPUContext object at 0x7fb439b3bcd0>" to i8*))
...
@".const.<numba.core.cpu.CPUContext object at 0x7fb439b3bcd0>" = internal constant [53 x i8] c"<numba.core.cpu.CPUContext object at 0x7fb439b3bcd0>\00"
